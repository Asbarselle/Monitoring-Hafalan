...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        // Recalculate hafalan predictions daily at 1 AM
        $schedule->command('hafalan:recalculate-predictions --limit=100')
            ->dailyAt('01:00')
            ->withoutOverlapping()
            ->appendOutputTo(storage_path('logs/predictions-calculation.log'));
