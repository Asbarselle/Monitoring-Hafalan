...
class NotificationService
{
    ...
    public static function notifyHafalanAddition(Hafalan $hafalan)
    {
        try {
            ...
            foreach ($parents as $parent) {
                ...
                // Buat pesan
                $message = self::createMessage('hafalan_addition', $hafalan, $parent);
                ...
                if ($parent->notify_email && $parent->email) {
                    ...
                    self::sendEmail($hafalan, $parent, $message, 'hafalan_addition');
                ...
                if ($parent->notify_app) {
                    ...
                    self::sendAppNotification($hafalan, $parent, $message, 'hafalan_addition');
                }
            }
     ...
     */
    private static function createMessage($type, Hafalan $hafalan, User $parent)
    {
