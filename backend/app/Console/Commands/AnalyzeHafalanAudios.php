...
class AnalyzeHafalanAudios extends Command
{
     ...
     * @var string
     */
    protected $description = 'Analyze audio files stored locally for hafalan records';
    ...
    public function handle(AudioAnalysisService $audioService)
    {
        ...
        $query = Hafalan::whereNotNull('audio_path');
        ...
        foreach ($hafalans as $hafalan) {
            try {
                $result = $audioService->analyzeAudio($hafalan->audio_path);
