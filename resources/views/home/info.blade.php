        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #e9ecef;">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScAT2X5IzdTCkw7W-w76XUZwhkVwBV_n_zXswkoXobdoCRePA/viewform?usp=publish-editor" target="_blank" class="btn btn-primary" style="background-color: #2c5530; border-color: #2c5530;">
                        <i class="bi bi-google"></i> Buka Form Pendaftaran
                    </a>
                </div>
            </div>
        </div>
