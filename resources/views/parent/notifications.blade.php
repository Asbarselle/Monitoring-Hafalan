    ...
    <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" id="check_whatsapp" 
                               {{ $user->notify_whatsapp ? 'checked' : '' }} disabled>
                        <label class="form-check-label" for="check_whatsapp">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <ul class="small mb-0">
                    <li>Aktifkan WhatsApp untuk notifikasi instan</li>
